  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-1 pb-1 mb-1 d-flex">
        <div class="image">
          <img src="<?php echo $URL;?>/public/imagenes/Icono_usuarios.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
