...
$html = '
<p style="text-align: center"><b> REPORTE DEL LISTADO DE ESPACIOS</b></p>
<table border="1" cellpadding="3">
<tr>
<th style="background-color: #c0c0c0; text-align: center; width: 5%;"><b>N°</b></th>
    <th style="background-color: #c0c0c0; text-align: center; width: 15%;"><b>N° ESPACIO</b></th>
        ...
        foreach ($mapeos as $mapeo) {
          ...
          $contador = $contador + 1;
            $html .= '
                ...
                <td style= "text-align: center">'.$numero_espacio.'</td>
                </tr>
            ';
        }
